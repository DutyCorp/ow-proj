...
<head>
	...
	<script type="text/javascript">
		$(function(){
	      	$("#cURL").text(window.location.pathname);
	    });
	</script>
...
<body>	
	<div id="main" class="container">
		...
		<h4>The requested URL <b id="cURL"></b> doesn't exist. Sorry about that 😕</h4>
		<!--<h6>Time to fix : Forever</h6>-->
		<img src="/a/{{ Crypt::encrypt('OWLogo.png') }}" style="width: 200px; margin-top: 40%;">
	</div>
</body>
</html>